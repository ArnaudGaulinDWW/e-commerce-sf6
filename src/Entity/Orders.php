...
class Orders
{
    ...
    #[ORM\OneToMany(mappedBy: 'orders', targetEntity: OrdersDdetails::class)]
    private $ordersDdetails;

    #[ORM\OneToMany(mappedBy: 'orders', targetEntity: OrdersDetail::class, orphanRemoval: true)]
    private $ordersDetails;

    public function __construct()
    {
        $this->ordersDdetails = new ArrayCollection();
    ...
    /**
     * @return Collection<int, OrdersDdetails>
     */
    public function getOrdersDdetails(): Collection
    {
        return $this->ordersDdetails;
    }
    /**
